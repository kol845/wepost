    ...
    <FooterContainer>
      ...
      <Info>
        <Contact>
          ...
          <a href="mailto:info@google.com">Email: hi@wepost.com</a>
      ...
      <Navigation>
        <li>
          <Link href="https://instagram.com">Products</Link>
        </li>
        <li>
          <Link href="https://twitter.com">Pricing</Link>
        </li>
        <li>
          <Link href="https://facebook.com">About us</Link>
        </li>
      </Navigation>
      <LinkTop />
    </FooterContainer>
